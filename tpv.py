...
def bong_game():
    global stagegong, bong_summa_index, active, bong_buttons, bong_summa, bong_stop, bong_stopped, ROUND_NUMBER, happy_variant, LAPS_PASSED
    pas.place_forget()
    zamena.place_forget()
...
def yep():
    global QUESTIONS_PASSED, ROUND_NUMBER, tick, FLIPS, TIME_LEFT, SKIP_LEFT, bazaq_numbaz, bazaq_round, baza_zamen, baza_zamen_round, bazaq, infa, otvet_na_zamenu, parodytas_klausimas, LAPS_PASSED, morna
    QUESTIONS_PASSED += 1
